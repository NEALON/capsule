...
var Swiper = function (selector, params) {
    ...
    isSafari=true;//(navigator.userAgent.indexOf('Safari') != -1 && navigator.userAgent.indexOf('Chrome') == -1);
    ...
    _this.init = function(force, forceCalcSlides) {
        ...
        if (params.slidesPerView==='auto') {
            ...
            if(isH) {
                ...
                wrapper.style.width = (slidesWidth + 5)+'px';
    ...
    _this.swipeNext = function(internal){
        ...
        if (params.slidesPerView=='auto') {
            for (var i=0; i<_this.snapGrid.length; i++) {            	
            		if((-currentPosition - _this.snapGrid[i + 1]) >= -100 && (-currentPosition - _this.snapGrid[i + 1]) <= 100  ) {
    ...
    _this.swipePrev = function(internal){
        ...
        if (params.slidesPerView=='auto') {
            ...
            for (var i=1; i<_this.snapGrid.length; i++) {
            		if((-currentPosition - _this.snapGrid[i]) >= -100 && (-currentPosition - _this.snapGrid[i]) <= 100) {
	            			newPosition = -_this.snapGrid[i-1]
	                  break;
            		}
...
Swiper.prototype = {
    ...
    getWrapperTranslate : function (axis) {
        ...
        if (this.support.transforms && this.params.useCSS3Transforms && !isSafari) {
            if (axis=='x') {
    ...
    setWrapperTranslate : function (x, y, z) {
        ...
        if (this.support.transforms && this.params.useCSS3Transforms && !isSafari) {
            translate = 'translate3d(' + coords.x + 'px, ' + coords.y + 'px, 0px)';
    ...
    setTranslate : function (el, translate) {
        ...
        if(!isSafari) {
	        transformString = this.support.transforms3d ? 'translate3d('+(pos.x)+'px,'+(pos.y)+'px, 0px)' : 'translate('+(pos.x)+'px,'+(pos.y)+'px)';
