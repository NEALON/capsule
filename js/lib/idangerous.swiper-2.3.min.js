...
var Swiper = function (selector, params) {
    ...
    _this.swipeNext = function(internal){
        ...
        if (params.slidesPerView=='auto') {
            for (var i=0; i<_this.snapGrid.length; i++) {            	
            		if(-currentPosition == Math.floor(_this.snapGrid[i + 1]) || -currentPosition == Math.ceil(_this.snapGrid[i + 1]) || -currentPosition == Math.round(_this.snapGrid[i + 1])) {
	            			newPosition = -_this.snapGrid[i+2]
	                  break;
            		}
    ...
    _this.swipePrev = function(internal){
        ...
        if (params.slidesPerView=='auto') {
            ...
            for (var i=1; i<_this.snapGrid.length; i++) {
            		if(-currentPosition == Math.ceil(_this.snapGrid[i]) || -currentPosition == Math.floor(_this.snapGrid[i]) || -currentPosition == Math.round(_this.snapGrid[i])) {
	            			newPosition = -_this.snapGrid[i-1]
	                  break;
            		}
    ...
    _this.fixLoop = function() {
        ...
        //Fix For Positive Oversliding (if slidesPerView == auto)
        else if (params.slidesPerView == 'auto' && _this.activeIndex > _this.slides.length - _this.loopedSlides*2) {
            newIndex = -_this.slides.length + _this.activeIndex + _this.loopedSlides
            _this.swipeTo(newIndex, 0, false);
        }
        //Fix For Positive Oversliding
        else if (params.slidesPerView != 'auto' && _this.activeIndex > _this.slides.length - params.slidesPerView*2) {
            newIndex = -_this.slides.length + _this.activeIndex + _this.loopedSlides
            _this.swipeTo(newIndex, 0, false);
        }
    }
...
Swiper.prototype = {
    ...
    setWrapperTranslate : function (x, y, z) {
        ...
        if (this.support.transforms && this.params.useCSS3Transforms) {
            translate = this.support.transforms3d ? 'translate3d(' + Math.round(coords.x) + 'px, ' + coords.y + 'px, ' + coords.z + 'px)' : 'translate(' + coords.x + 'px, ' + coords.y + 'px)';
    ...
    setTranslate : function (el, translate) {
        ...
        var transformString = this.support.transforms3d ? 'translate3d('+(Math.round(pos.x))+'px,'+(pos.y)+'px,'+(pos.z)+'px)' : 'translate('+(pos.x)+'px,'+(pos.y)+'px)';
